	...
	<div class="center">
		...
		<form method="post" action="signup.do">
			...
			<input type="hidden" name="user_Pic" / value="her">
				...
				<div class="txt_field">
					<input type="file" id="phototext" name="user_Pic"><span></span>
				</div>
				<div class="language">
					<div>Preferred language</div>
					<input type="checkbox" name="user_Lang" value="java">java</input> <input
						type="checkbox" name="user_Lang" value="python">python</input> <input
						type="checkbox" name="user_Lang" value="c++">c++</input> <input
						type="checkbox" name="user_Lang" value="c">c</input> <input
						type="checkbox" name="user_Lang" value="javascript">javascript</input>
					<!-- <input type="hidden" name="user_Lang" value="java" /> -->
				</div> <input type="submit" value="회원가입" style="margin-top: 20px">
