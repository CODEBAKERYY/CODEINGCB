...
<body>
	...
	<div class="container" id="notice">
		...
		<br><br> <!-- 관리자 일때만 글쓰기버튼 활성화 --> <c:if
					test="${User.user_Grade == '관리자' && !empty User}">
					<div class="text-right">
						<button type="button" class="btn btn-secondary pull-right"
							onclick="location.href='notice_write.do'" style="width: 8%;">글쓰기</button>
					</div>
				</c:if> <br><br> <!--============== 공지사항 게시글 리스트 END ============== -->
										...
										<ul class="pagination">
											...
											<c:if test="${pageMaker.prev }">
												<li class="page-item"><a class="page-link"
													href="notice.do?page=${pageMaker.startPage - 1 }"
												...
												<c:choose>
													<c:when test="${idx eq page }">
														<li class="page-item active"><a class="page-link"
															href="notice.do?page=${idx }">${idx }</a></li>
													</c:when>
													<c:otherwise>
														<li class="page-item"><a class="page-link"
															href="notice.do?page=${idx }">${idx }</a></li>
											...
											<c:if test="${pageMaker.next && pageMaker.endPage>0 }">
												<li class="page-item"><a class="page-link"
													href="notice.do?page=${pageMaker.endPage + 1 }"
